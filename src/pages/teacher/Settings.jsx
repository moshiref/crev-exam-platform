      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <DashboardCard title="بيانات الحساب" delay={0.1}>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-display text-base font-extrabold text-slate-900">أ. أحمد فوزي</p>
              <p className="text-xs text-slate-400">مدرس الرياضيات · كود T-001</p>
              <Badge tone="success">نشط</Badge>
            </div>
          </div>
          <dl className="mt-5 divide-y divide-slate-100">
            <Row label="المادة" value="الرياضيات" />
            <Row label="المسمى الوظيفي" value="مدرس" />
            <Row label="رقم الهاتف" value="01011122233" ltr />
          </dl>
        </DashboardCard>
      </div>
    </div>
...
function Row({ label, value, ltr }) {
  return (
    <div className="flex items-center justify-between py-3">
      ...
      <dd className="text-sm font-bold text-slate-800" dir={ltr ? 'ltr' : 'rtl'}>{value}</dd>
    </div>
  )
}