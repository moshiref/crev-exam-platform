...
/**
 * Generic labeled text input for admin forms (Add/Edit Student, Teacher,
 * Subject, Settings...). Distinct from `components/auth/TextField` which
 * is tuned specifically for the public login screens.
 */
export default function Input({ label, id, error, className, ...inputProps }) {
  return (
