...
insert into public.teachers (id, name, subject, phone, status, username, password, subjects, stages, grades) values
  ('T-001', 'أ. أحمد فوزي', 'الرياضيات', '01011122233', 'Active', 'ahmed.fouzi', 'Ahmed@123', '["الرياضيات"]'::jsonb, '["ابتدائي","إعدادي","ثانوي"]'::jsonb, '["الأول الابتدائي","الثاني الابتدائي","الثالث الابتدائي","الرابع الابتدائي","الخامس الابتدائي","السادس الابتدائي","الأول الإعدادي","الثاني الإعدادي","الثالث الإعدادي","الأول الثانوي","الثاني الثانوي","الثالث الثانوي"]'::jsonb),
  ('T-002', 'أ. منى عبد الله', 'اللغة الإنجليزية', '01022233344', 'Active', 'mona.abdallah', 'Mona@123', '["اللغة الإنجليزية"]'::jsonb, '["إعدادي"]'::jsonb, '["الأول الإعدادي","الثاني الإعدادي","الثالث الإعدادي"]'::jsonb),
  ('T-003', 'أ. كريم سامي', 'العلوم', '01033344455', 'Active', 'karim.sami', 'Karim@123', '["العلوم"]'::jsonb, '["ابتدائي","ثانوي"]'::jsonb, '["الأول الابتدائي","الثاني الابتدائي","الثالث الابتدائي","الرابع الابتدائي","الخامس الابتدائي","السادس الابتدائي","الأول الثانوي","الثاني الثانوي","الثالث الثانوي"]'::jsonb),
  ('T-004', 'أ. هبة الدسوقي', 'اللغة العربية', '01044455566', 'Inactive', 'heba.desouky', 'Heba@123', '["اللغة العربية"]'::jsonb, '["إعدادي"]'::jsonb, '["الأول الإعدادي","الثاني الإعدادي","الثالث الإعدادي"]'::jsonb),
  ('T-005', 'أ. محمود صلاح', 'الدراسات الاجتماعية', '01055566677', 'Active', 'mahmoud.salah', 'Mahmoud@123', '["الدراسات الاجتماعية"]'::jsonb, '["ابتدائي","إعدادي","ثانوي"]'::jsonb, '["الأول الابتدائي","الثاني الابتدائي","الثالث الابتدائي","الرابع الابتدائي","الخامس الابتدائي","السادس الابتدائي","الأول الإعدادي","الثاني الإعدادي","الثالث الإعدادي","الأول الثانوي","الثاني الثانوي","الثالث الثانوي"]'::jsonb)
on conflict (id) do nothing;
